...
public class Model_Account_Accreditations implements GEntity {
    ...
    public String getTable() {
        return "Account_Client_Acccreditation";
    }
...
//            }
    ...
    /**
     * Description: Sets the xCompnyNm of this record.
     *
     * @param fsValue
     * @return True if the record assignment is successful.
     */
    ...
    /**
     * @return The xCompnyNm of this record.
     */
    ...
    /**
     * Description: Sets the xMobileNo of this record.
     *
     * @param fsValue
     * @return True if the record assignment is successful.
     */
    public JSONObject setMobileNo(String fsValue) {
        return setValue("xMobileNo", fsValue);
    }

    /**
     * @return The xMobileNo of this record.
     */
    ...
    public String getSQL(){
        return "SELECT " +
                ...
                "  LEFT JOIN Barangay g " +
                "    ON c.sBrgyIDxx = g.sBrgyIDxx " +
                "  LEFT JOIN TownCity h " +
                "    ON c.sTownIDxx = h.sTownIDxx " +
