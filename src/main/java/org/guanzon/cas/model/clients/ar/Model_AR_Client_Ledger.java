 ...
 */
public class Model_AR_Client_Ledger implements GEntity {
     ...
     */
    public Model_AR_Client_Ledger(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject openRecord(String fsCondition) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, " sCntryCde = " + SQLUtil.toSQL(fsCondition));
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE){
            ...
            if (pnEditMode == EditMode.ADDNEW){
                ...
                org.guanzon.cas.models.Model_AP_Client_Ledger loOldEntity = new org.guanzon.cas.models.Model_AP_Client_Ledger(poGRider);
