...
import org.guanzon.cas.inventory.models.*;
 ...
 * @author User
 */
public class testInvHistLedger implements GEntity {
     ...
     */
    public testInvHistLedger(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                testInvHistLedger loOldEntity = new testInvHistLedger(poGRider);
